...
class Advisor(models.Model):
    ...
    i = models.ForeignKey('Instructor', models.DO_NOTHING, blank=True, null=True)
...
class Takes(models.Model):
    id = models.OneToOneField(Student, models.DO_NOTHING, db_column='id', primary_key=True)
...
class Teaches(models.Model):
    id = models.OneToOneField(Instructor, models.DO_NOTHING, db_column='id', primary_key=True)
    course = models.ForeignKey(Section, models.DO_NOTHING)
    sec_id = models.CharField(max_length=8)
    semester = models.CharField(max_length=6)
    year = models.DecimalField(max_digits=4, decimal_places=0)
...
class Test2(models.Model):
    ...
    middle_name = models.CharField(db_column='Middle_Name', max_length=32, blank=True, null=True)  # Field name made lowercase.
    last_name = models.CharField(db_column='Last_Name', max_length=32, blank=True, null=True)  # Field name made lowercase.
    classpfx = models.CharField(db_column='Classpfx', max_length=32, blank=True, null=True)  # Field name made lowercase.
    classno = models.IntegerField(db_column='Classno', blank=True, null=True)  # Field name made lowercase.
...
class Users(models.Model):
    ...
    tstz = models.DateTimeField(blank=True, null=True)
